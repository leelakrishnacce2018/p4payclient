...
class Sidebar extends Component {
  ...
  callLoggedNavItems(){
    //console.log("++++++"+localStorage.getItem("loggedNav"))
    if (localStorage.getItem("loggedNav") === null) {
     
      location.href="/sam"
    }
    return  localStorage.getItem("loggedNav");
      ...
      return (
        <NavItem key={key} className={classes.item}  >
          { isExternal(url) ?
            ...
            :
            <NavLink to={url} className={classes.link} activeClassName="active" onClick={this.hideMobile} replace={true}>
              <i className={classes.icon}></i>{item.name}{badge(item.badge)}
            </NavLink>
          }
        </NavItem>
      ...
      <div className="sidebar">
        ...
        <nav className="sidebar-nav">
          <Nav>
            ...
            {navList(JSON.parse(this.callLoggedNavItems()))
            }
