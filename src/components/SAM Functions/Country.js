...
import {  getBuList, deactiveRecord, updateBu, createBu, getCountries, deactiveCun, updateCountry, createCountry, getDelCountries } from './../../util/APIUtils';
    ...
    return (
      ...
      <ToastContainer position="top-right"  autoClose={5000} style={containerStyle} closeButton={false}/>
        ...
        <Card  >
         ...
         exportCSV>
           <TableHeaderColumn isKey dataField="cunId" dataField="cunId" dataFormat={this.priceFormatter.bind(this)} export={false} >S.No</TableHeaderColumn>
            <TableHeaderColumn dataField="cname" dataSort  csvHeader='Country Name' tdStyle={ { whiteSpace: 'normal' } } thStyle={ { whiteSpace: 'normal' }}  >Country Name</TableHeaderColumn>            
...
class CustModal extends Component {
    ...
    componentDidMount() { 
       ...
       {         
       this.setState({
            cname: this.props.inputrecord.cname,
    ...
    onCname(e) {
     ...
     {
      this.setState({
        cname: e.target.value.replace(defaultRegex, ""),
        pasteAction:false
      });
    ...
    blurCname(e) {
     ...
     // alert(allFoundCharacters.length);
      ...
      document.getElementById("ctryError").textContent = "Enter Country Name";
      ...
      document.getElementById("ctryError").textContent = "Country Name Must Be More Than 3  Characters";
    ...
    render() {
      ...
      return (
        ...
        <Card>
              ...
              <CardBody>
                <FormGroup>
                    <Input type="text"  value={this.state.cunId}  hidden/>                   
                  </FormGroup> 
                  <FormGroup>
                    <Label htmlFor="nf-email">Country Name<span style={{color:'red'}}>*</span></Label>
                    <Input type="text" placeholder="Country Name"  style ={this.state.borderColor}  maxLength ="20" minLength ="4" value= {this.state.cname.replace(/^ /, '')} onPaste ={this.onPaste}  onChange = {this.onCname} onKeyPress={(e) => OnlyAlphabic(e)}  onBlur = {this.blurCname} />
