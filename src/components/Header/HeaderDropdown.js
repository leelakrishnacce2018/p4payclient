...
import { logoutRequest } from '../../util/APIUtils';
  ...
  dropAccnt() {
    ...
    return (
      <Dropdown nav isOpen={this.state.dropdownOpen} toggle={this.toggle}>
        <DropdownToggle nav>
          <img src={'img/avatars/500.png'} className="img-avatar" />
        </DropdownToggle>
        <DropdownMenu right>
          <DropdownItem header tag="div" className="text-center"><strong>Hi {localStorage.getItem("username")}!</strong></DropdownItem>
         {// <DropdownItem><i className="fa fa-user"></i> Profile</DropdownItem>          
          }<DropdownItem onClick={this.Logout }><i className="fa fa-lock"></i>Logout</DropdownItem>
          {//<DropdownItem><i className="fa fa-lock" onSelect={this.Logout} ></i> Logout</DropdownItem>
          }
         {/* <DropdownItem>
